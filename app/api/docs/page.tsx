    ...
    <main className="mx-auto max-w-7xl z-10 justify-center items-center mb-12 flex w-3/6 ">
        <div className="flex justify-center items-center mx-auto">
            <div className="mt-8">
                ...
                <Code size="lg" className="w-full max-md:text-[9px] break-words"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/key=(secret)/models/perpage=(number)/page=(number)?type=(kits.ai / rvc)</span></Code>
                </div>
                ...
                <div className="w-full prose prose-neutral my-8">
                <Code size="lg" className="w-full max-md:text-[9px] break-words"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/key=(secret)/models/search?name=(model_name)&type=(kits.ai / rvc)</span></Code>
                </div>
                <Table removeWrapper aria-label="Example static collection table">
                <TableHeader>
                <TableColumn>PARAMETER</TableColumn>
                ...
                <div className="w-full prose prose-neutral my-8">
                <Code size="lg" className="w-full max-md:text-[9px] break-words"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/key=(secret)/models/user=(username)?type=(kits.ai / rvc)</span></Code>
                </div>
                <Table removeWrapper aria-label="Example static collection table">
                <TableHeader>
                <TableColumn>PARAMETER</TableColumn>
                ...
                <div className="w-full prose prose-neutral my-8">
                <Code size="lg" className="w-full max-md:text-[9px] break-words"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/ping</span></Code>
                </div>
