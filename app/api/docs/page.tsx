        ...
        <div className="flex justify-center items-center mx-auto">
            <div className="mt-8">
                <div className="w-full prose prose-neutral mb-10">
                    ...
                    <p className="mb-3 break-words max-md:max-w-sm">Welcome to the Applio API documentation! Our API is simple, fast and free, however, before you start using it, it is important that you consult our documentation.</p>
                ...
                <p className="my-4 max-md:max-w-sm">Retrieve information about multiple models using the following API endpoint:</p>
                <div className="w-full prose prose-neutral my-8 max-md:max-w-sm hidden md:block">
                <Code size="lg" className="w-full max-md:text-[9px] break-words select-all max-md:max-w-sm"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/key=(secret)/models/perpage=(number)/page=(number)?type=(string)</span></Code>
                </div>
                ...
                <Code size="lg" className="w-full max-md:text-[9px] break-words select-all"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/key=(secret)/models/search?name=(model_name)&type=(kits.ai / rvc)</span></Code>
                </div>
                <Table removeWrapper className="max-md:max-w-sm">
                <TableHeader>
                <TableColumn>PARAMETER</TableColumn>
                ...
                <div className="w-full prose prose-neutral my-8 hidden md:block">
                <Code size="lg" className="w-full max-md:text-[9px] break-words select-all"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/key=(secret)/models/user=(username)?type=(kits.ai / rvc)</span></Code>
                </div>
                ...
                <div className="w-full prose prose-neutral my-8 hidden md:block">
                <Code size="lg" className="w-full max-md:text-[9px] break-words select-all"><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/ping</span></Code>
                </div>
