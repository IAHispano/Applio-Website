...
export default function docsApi() {
  return (
    <main className="mx-auto max-md:mx-4 md:max-w-7xl z-10 justify-center items-center mb-12 flex w-3/6 ">
        <div className="flex justify-center items-center mx-auto">
            <div className="mt-8">
                ...
                <Code size="lg" className="w-full max-md:text-[9px] break-words select-all "><span className="text-[#ff9492]">GET</span> <span className="text-[#91cbff]">https://api.applio.org/key=(secret)/models/perpage=(number)/page=(number)?type=(kits.ai / rvc)</span></Code>
                </div>
