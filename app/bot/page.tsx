...
export default function ErrorPage() {
    ...
    <Accordion type="single" collapsible className="w-full">
      ...
      <AccordionItem value="item-3">
        <AccordionTrigger>How do I invite the bot to my server?</AccordionTrigger>
        <AccordionContent>
          Simply click <span className="text-green-500"><Link href="https://discord.com/api/oauth2/authorize?client_id=1144714449563955302&permissions=277026719809&scope=bot">here</Link></span> and follow the steps discord tells you to follow. 
        </AccordionContent>
      </AccordionItem>
    </Accordion>
    <Button className="mt-24">
      <Link href="/models">
      Do you want to see all our models?
      </Link>
      </Button>
  </section>
    )
