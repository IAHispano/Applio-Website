    ...
    <section className="container flex flex-col justify-center items-center pb-8 pt-6 md:py-10 mx-auto text-center max-w-7xl my-10">
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-5">
          ...
          <AccordionContent>
            If you encounter any bugs or issues while using Applio, please
            don't hesitate to contact us through our support channels or by
            filing a bug report on our GitHub repository. We appreciate your
            feedback!
          </AccordionContent>
        </AccordionItem>
      </Accordion>
