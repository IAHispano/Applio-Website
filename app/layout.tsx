...
if (
  ...
  console.error(
    " ❌ We have not found any API KEYS, we understand that you are in development mode so you will not have errors but you will not be able to access database functionality."
  )
}
