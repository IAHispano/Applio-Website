  ...
  <div className="flex-col justify-center items-center text-center w-full md:min-h-[90svh] px-5 pb-[500px] flex relative overflow-hidden md:min-w-[110rem] md:max-w-[110rem] mx-auto">
    ...
    {data.length > 0 && (
      <div className="flex flex-col justify-center md:items-start ">
        <p className="md:text-3xl text-xl font-bold md:text-left text-center">Featured models</p> 
        <InfiniteMovingCards
          direction="right"
          speed="slow"
          data={data}
      ...
      <div className="pt-12">
        <div className="flex flex-col max-w-[100rem]">
          {data.length > 0 && ( <p className="md:text-3xl textl-xl font-bold md:text-left text-center">Explore <Counter value={Number(count)} /> models</p> )}
          <ModelsData />
        </div>
      </div>
    </div>
