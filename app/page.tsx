  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <main className="flex flex-col w-full justify-start items-center text-center relative z-[1]">
        ...
        <a className="p-2 bg-black/30 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex hover:shadow-xl hover:shadow-[#00AA68]/50 gtransition" role="alert" href="/premium">
