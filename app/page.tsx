...
export default function IndexPage() {
  ...
  <section className="container flex flex-col justify-center items-center h-screen pb-8 pt-6 md:py-10 mx-auto text-center max-w-7xl">
    ...
    <h1 className="text-6xl font-bold leading-tight tracking-tighter md:text-8xl my-4">Create, experiment, enjoy with <span className="bg-gradient-radial text-transparent bg-clip-text">Applio</span>.</h1>
