    ...
    <div className="flex flex-col overflow-hidden">
      ...
      <main className="flex flex-col w-full justify-start items-center text-center relative z-[1]">
        <div className="min-h-[70svh] flex flex-col justify-center items-center w-full p-10 pt-32  relative">
          <p className="text-3xl md:text-7xl font-bold tracking-tight md:tracking-tighter py-10 text-white max-w-4xl">
            A universe of possibilities powered by AI
          </p>
          <p className="font-mono max-w-xl tracking-wide">
          ...
          <div className="flex justify-center items-center gap-4 flex-wrap py-8">
            <a
              className="py-2 px-3.5 flex items-center gap-2 bg-[#00AA68]/20 hover:opacity-50 gtransition text-[#00DB86] rounded-lg flex gap-2 z-[1]"
            ...
            <a
              className="py-2 px-3.5 flex items-center gap-2 bg-[#00AA68]/20 hover:opacity-50 gtransition text-[#00DB86] rounded-lg flex gap-2 z-[1]"
              href="https://discord.com/invite/iahispano"
              rel="noreferrer"
              target="_blank"
            >
              <svg
