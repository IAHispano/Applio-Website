...
All requests require a token included in the `Authorization` header for authentication. Visit the [Authorization](/docs/api/authorization) page for more information.
</Callout>
...
**Headers:**
- **Authorization**: [Token](/docs/api/authorization) (required)
- **Parameters:**
