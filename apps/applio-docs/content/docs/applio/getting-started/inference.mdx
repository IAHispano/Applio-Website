...
- **In case of training, your voice model needs more [training](/applio/getting-started/training) or is overtraining.**
- **Remove the reverb, double vocals and noise from your acapella, you can check the [UVR 5 or MVSEP guide](/applio/guides/audio-isolating/uvr).**
- **The dataset of your model contained noise, you need to [clean the dataset](/applio/guides/create-datasets/how-create-datasets).**
