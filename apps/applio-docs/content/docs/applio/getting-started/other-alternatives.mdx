...
- Then, in the Applio interface, input your **model name**, use the same **sample rate**, and proceed to the last part of the train tab. Set the same **[batch size](/docs/applio/faq#terminology)**, **[pretrained](/docs/applio/getting-started/pretrained#how-to-use-pretraineds) (if you used)** and increase the number of epochs you want to train.
