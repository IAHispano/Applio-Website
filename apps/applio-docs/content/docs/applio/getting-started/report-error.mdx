...
<ImageZoom src="/images/report-bug.png" alt="Report a bug" width={800} height={400} />

<Callout type="info" className="shadow-xl shadow-blue-500/10">
  Remember to check the [FAQ section](/applio/faq), there are some bugs
  that are still present in the current version of applio and can be found in
  this section. You can also go to the [Discord
  Server](https://discord.gg/ai-hispano-1096877223765606521) and share your problem in the help
