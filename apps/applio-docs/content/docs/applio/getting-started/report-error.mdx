...
<Callout type="info" className="shadow-xl shadow-blue-500/10">
  Remember to check the FAQ section, there are some bugs that are
...
Unfortunately, Google Colab is currently unavailable as Google has taken measures to restrict access to Colab services, including Applio. Thanks to our team, we have been able to bring Applio back. [More information here](/applio/getting-started/other-alternatives).
