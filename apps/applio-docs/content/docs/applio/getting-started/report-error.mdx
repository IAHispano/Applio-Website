...
<Callout type="info" className="shadow-xl shadow-blue-500/10">
  Remember to check the [FAQ section](/docs/applio/faq), there are some bugs
...
If an error related to Tensorboard occurs, it's likely that no dependencies were installed correctly. [Review if you have the latest installer version](/docs/applio/getting-started/installation).
