...
- If you don’t have an compatible GPU, we offer alternatives to [run Applio in the cloud.](/docs/applio/getting-started/other-alternatives)
</Callout>
...
- [Don't know how to create a dataset?, check the dataset section](/docs/applio/guides/create-datasets/create-datasets)
...
- [Don't know how to check sample rate?, check the Audio Analizer section](/docs/applio/getting-started/audio-analizer)
</Step>
<Step>
...
- **Pretrained:** Uses the RVC pretrained, used for training common models, uncheck if you want to make a pretrain. Learn how to use it [here](/docs/applio/getting-started/pretrained).
