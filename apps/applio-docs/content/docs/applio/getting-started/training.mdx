...
- [Don't know how to create a dataset?, check the dataset section](/applio/guides/create-datasets/create-datasets)
...
- [Don't know how to check sample rate?, check the Audio Analizer section](/applio/getting-started/audio-analizer)
</Step>
<Step>
