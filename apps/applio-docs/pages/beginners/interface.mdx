...
- **Make an inference/use voices;** you can go to the [inference section](/getting-started/download-models).
...
- **Use custom Pretrained (like Ov2 and RIN_E2):** [Load custom Pretrained](/getting-started/pretrained).
