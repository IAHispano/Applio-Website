...
<Steps>
### Step 1: Did you install applio in a directory with spaces or non ASCII characters in the path?
...
### Step 2: Did you have the antivirus/firewall enabled during the installation?

If you did, please reinstall applio with the antivirus disabled.

### Step 3: Did you open the run-applio.bat file with administrator privileges?
