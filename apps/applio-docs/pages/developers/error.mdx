...
You can also go to the **report a bug** section in Applio to easily record what is happening. -![Applio tool to record an error](/Bug.png)

<Callout type="info" emoji="ℹ️">
  Remember to check the [FAQ section](/faq), there are some bugs
  that are still present in the current version of applio and can be found in
  this section. You can also go to the [Discord
  Server](https://discord.gg/iahispano) and share your problem in the help
...
If an error related to Tensorboard occurs, it's likely that no dependencies were installed correctly. [Review if you have the latest installer version](/getting-started/installation).

### Also, please check if you have done any of the following:

<Steps>
### Check 1: Did you install applio in a directory with spaces or non ASCII characters in the path?
...
### Check 2: Did you have the antivirus/firewall enabled during the installation?

If you did, please reinstall applio with the antivirus disabled.

### Check 3: Did you open the run-applio.bat file with administrator privileges?
