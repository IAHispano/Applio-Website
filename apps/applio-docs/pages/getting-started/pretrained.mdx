...
32K
<Steps>
D file [D file download link](https://huggingface.co/shiromiya/nanashi-pretrain/resolve/main/v1/D_nanashi_v1.pth?download=true)

G file [G file download link](https://huggingface.co/shiromiya/nanashi-pretrain/resolve/main/v1/G_nanashi_v1.pth?download=true)
</Steps>
