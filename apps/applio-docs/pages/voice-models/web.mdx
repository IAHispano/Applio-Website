...
- Choose the model you wish to use and click on copy icon to get the link or on download icon to download it, then go to the [Download](/get-started/inferencing.md) tab of Applio.