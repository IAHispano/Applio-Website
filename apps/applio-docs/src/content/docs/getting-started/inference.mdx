...
```bash
# Basic conversion
python core.py infer -i input.wav -o output.wav -m logs/MyModel/G_1000.pth

# With pitch adjustment and specific settings
python core.py infer -i input.wav -o output.wav -m logs/MyModel/G_1000.pth -id logs/MyModel/MyModel.index -p -3 -f crepe -e contentvec

# Batch processing an entire folder
python core.py batch_infer -i ./input_folder -o ./output_folder -m logs/MyModel/G_1000.pth
```
