...
- **Download all [custom pretrains](/getting-started/pretrained/):** Allows direct downloading of custom pretrains to Applio.

![Applio Colab Custom Pretrained](/images/extra-colab.png)
