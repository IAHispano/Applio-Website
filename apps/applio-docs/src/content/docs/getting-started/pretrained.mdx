...
<Aside type="note">
  **Pre-trained models** are _not_ meant to be used for inference directly, only as a base for training. You can find **inferrence models** of characters and celebreties and such [here](https://applio.org/search), and learn how to use them in [Installing Inferrence Models](/getting-started/installing-inferrence-models).
</Aside>
