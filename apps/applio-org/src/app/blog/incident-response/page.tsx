export default function incidentResponsePage() {
  return (
    ...
    <div className="flex flex-col w-full gap-24">
      ...
      <div>
      <h1 className="md:text-3xl text-2xl text-neutral-200">About Applio Premium</h1>
      <div className="h-0.5 bg-neutral-600 rounded-xl w-full my-0.5"/>
      <div className="prose text-neutral-300 text-balance gap-2 mt-4">
      <p>
        We regret to inform you that due to <span className="text-white underline">Stripe's policies</span>, our account was suspended as <span className="text-white underline">they do not allow non-profit organizations to accept donations</span>. <span className="text-white underline">This forced us to</span> close our account and <span className="text-white underline">discontinue our premium service</span>.
      </p>
      <p>
        We are no longer charging our premium users, and <span className="text-white underline">we are actively working on restoring the features</span> that were part of our premium offering.
      </p>
      <p>
