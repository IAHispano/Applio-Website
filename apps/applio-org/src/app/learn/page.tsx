        ...
        <main className="md:min-h-[80svh] w-full h-full flex flex-col lg:px-72 items-center mx-auto mt-12 gap-10 max-md:px-4">
            <section className="flex flex-col w-full">
                <a className="p-2 w-fit bg-white/10 border border-white/20 items-center max-md:justify-center max-md:mx-auto text-black leading-none rounded-full flex lg:inline-flex slow mb-5">
                    <span className="font-semibold mx-2 md:text-left max-md:text-center md:flex-auto text-white">Guides</span>
                </a>
                <div className="flex max-md:flex-col md:justify-between w-full">
                <h1 className="md:text-6xl lg:max-w-5xl text-4xl font-bold leading-8 max-md:text-center">Learn with Applio</h1>
                <a href="/learn/create" className="mt-2 px-4 rounded-full h-10 bg-white hover:bg-white/80 slow text-black font-semibold flex justify-center items-center gap-2 max-md:mt-6">
                <span>
