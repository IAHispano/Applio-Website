...
export default function PrivacyPage() {
	return (
		<div className="flex flex-col items-start min-h-screen mt-24 max-w-5xl mx-auto p-4">
			<h1 className="mb-4 text-xl md:text-3xl font-bold">Privacy Policy</h1>
			...
			<ul className="list-disc list-inside mb-4">
				<li>Your Discord username and email</li>
			...
			<ul className="list-disc list-inside mb-4">
				...
				<li>
					...
					market research purposes. We may contact you by email. We may use the
			...
			<ul className="list-disc list-inside mb-4">
				<li>
					By using our services you agree to us using your personal information
					for direct marketing purposes, you may change your mind at any time by
					writing to or emailing us at support@applio.org
				</li>
				<li>
				...
				<li>
					...
					you. If you would like a copy of the information held on you, email to
					support@applio.org
				</li>
				<li>
