	...
	return (
		<div className="flex flex-col items-start min-h-screen mt-24 max-w-5xl mx-auto p-4">
			<div className="md:m-4">
				<h1 className="mb-4 text-xl md:text-3xl font-bold">Terms of Service</h1>
				<p className="mb-4">Last updated: February 04, 2024</p>

				<p className="mb-4">
					These Terms of Service (&#34;Terms&#34;) govern your access to and use
					of our website and services. By using our website or services, you
				...
				<p className="mb-4">
					...
					Terms. If you do not agree to these Terms, you may not use our website
					or services.
				</p>
				...
				<p className="mb-4">
					...
					continued use of our website or services after any changes to these
					Terms constitutes your acceptance of the changes.
				</p>
				<h2 className="text-2xl font-bold mb-2">3. Your Account</h2>
				<p className="mb-4">
					You may be required to create an account to use our services. You are
				...
				<p className="mb-4">
					...
					not use our content without our permission.
				</p>
				...
				<p className="mb-4">
					We will not be liable for any damages arising from your use of our
					website or services, including, but not limited to, direct, indirect,
				...
				<p className="mb-4">
					...
					support@applio.org or https://discord.gg/ai-hispano-1096877223765606521.
				</p>
			</div>
		</div>
	);
