...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center max-md:mx-4 md:-mt-28">
      ...
      <section className="z-30 mt-72 text-center flex justify-center items-center md:mx-auto flex-col">
      <a className="p-2 bg-white/10 border border-white/20 items-center text-black leading-none lg:rounded-full flex lg:inline-flex hover:shadow-xl hover:shadow-white/50 slow mb-5" role="alert" href="/premium">
      ...
      <h1 className="md:text-6xl md:max-w-5xl max-w-xl text-3xl font-bold leading-8">Dive into a world of endless possibilities fueled by advanced AI audio technology</h1>
      ...
      <div className="mt-[37svh]">
        <div className="md:px-8 rounded-2xl bg-white/10 w-fit text-white border border-white/20">
          Features
        </div>
      ...
      <div className="mt-[30svh] mb-4 py-8 h-[90svh] w-full md:mx-24 rounded-3xl bg-gradient-to-bl from-[#110F0F] via-white/[0.1] to-[#110F0F] md:px-12 rounded-t-xl">
      <h1 className="text-4xl font-bold">Testimonials</h1>
      <p className="font-light text-white/90 mt-2">See what users are saying about Applio.</p>
      <TestimonialsShowcase />
      <div className="mt-12">
      <a className="bg-white rounded-2xl md:px-14 py-3 text-black font-medium cursor-pointer">Join Discord</a>
