            ...
            <div className="mt-44 mb-4 flex flex-col w-full h-full justify-center items-center">
                <article className="flex max-md:flex-col w-full h-full justify-center items-center">
                    <div className="flex flex-col text-left md:w-[40%] md:h-[80%]">
                        <h2 className="text-4xl font-semibold">An advanced AI audio technology tool.</h2>
                        <h3 className="text-neutral-200 max-w-xl">Pioneering Open-Source Ecosystem Unveiling the Latest Breakthroughs in AI Voice Cloning Technologies.</h3>
                    </div>
                ...
                <article className="flex max-md:flex-col w-full h-screen justify-center items-center">
                    ...
                    <div className="flex flex-col justify-right items-end text-right md:w-[40%] h-[80%]]">
                        ...
                        <h3 className="text-neutral-200 max-w-sm w-full">You can make inferences with more than 20k models or create your own, plus you have text to speech or you can use one of our plugins.</h3>
                    </div>
                </article>
                <article className="flex flex-col justify-center items-center mx-auto w-full h-full gap-8">
                    <h1 className="text-5xl font-semibold mt-28 max-w-3xl text-center">Download the world's most widely used voice cloning tool</h1>
