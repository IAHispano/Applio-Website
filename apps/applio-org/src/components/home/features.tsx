export default function Features() {
    return (
        ...
        <article className="grid md:grid-cols-3 gap-5 w-full h-1/5 mt-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
            ...
            <div className="rounded-2xl bg-gradient-to-b from-white/[.03] to-[#110F0F] w-full h-full flex flex-col p-4 text-left border border-white/10">
            <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="22" viewBox="0 0 24 22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
            ...
            <div className="rounded-2xl bg-gradient-to-b from-white/[.03] to-[#110F0F] w-full h-full flex flex-col p-4 text-left border border-white/10">
            <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="22" viewBox="0 0 24 22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 8 6 6"/><path d="m4 14 6-6 2-3"/><path d="M2 5h12"/><path d="M7 2h1"/><path d="m22 22-5-10-5 10"/><path d="M14 18h6"/></svg>
            ...
            <div className="rounded-2xl bg-gradient-to-b from-white/[.03] to-[#110F0F] w-full h-full flex flex-col p-4 text-left border border-white/10">
            <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="22" viewBox="0 0 24 22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4m16 0 1.28 2.55a1 1 0 0 1-.9 1.45H3.62a1 1 0 0 1-.9-1.45L4 16"/></svg>
            ...
            <div className="rounded-2xl bg-gradient-to-b from-white/[.03]  to-[#110F0F] w-full h-full flex flex-col p-4 text-left border border-white/10">
            <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="22" viewBox="0 0 24 22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
            ...
            <div className="rounded-2xl bg-gradient-to-b from-white/[.03] to-[#110F0F] w-full h-full flex flex-col p-4 text-left border border-white/10">
            <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="22" viewBox="0 0 24 22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
