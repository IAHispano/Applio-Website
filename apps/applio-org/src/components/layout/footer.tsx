      ...
      <div className="m-auto grid min-h-64 max-w-[100rem] relative grid-cols-2 gap-6 p-8 pb-20 pt-10 sm:grid-cols-2 lg:grid-cols-7 z-[1]">
        <div className="col-span-2 gap-4 flex flex-col">
          ...
          <div className="flex gap-4">
            <a href="https://www.linkedin.com/company/ai-hispano/" target="_blank" rel="noreferrer">
            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="LinkedIn" role="img">
