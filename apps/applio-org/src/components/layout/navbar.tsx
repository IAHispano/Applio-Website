                ...
                onMouseLeave={handleMouseLeaveProducts}>
                        ...
                        <div
                            className={`dropdown-menu absolute mt-6 bg-neutral-800 rounded-lg p-4 px-6 border border-white/20 backdrop-filter backdrop-blur-lg transition-opacity duration-300 ease-in-out ${
                                isOpenProducts ? "opacity-100 visible" : "opacity-0 invisible"
                            }`}
                        >   
                ...
                onMouseLeave={handleMouseLeaveAbout}>
                        ...
                        <div className="flex gap-2">
                            ...
                            <a className="flex gap-2 cursor-pointer hover:bg-white/20 rounded-md w-full p-2 slow h-18" href="/about/mission">
                                ...
                                <p className="text-xs text-neutral-200">What drives us at Applio.</p>
                                </div>
                            </a>
                            <a className="flex gap-2 cursor-pointer hover:bg-white/20 rounded-md w-full p-2 slow h-18" href="https://discord.gg/iahispano" target="_blank">
                                <div className="flex border border-white/20 rounded-md justify-center items-center w-12 h-12">
                                    <svg className="w-5 h-5" viewBox="0 0 202 242" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className="text-xs text-neutral-200">Get in touch with us.</p>
                                </div>
                            </a>
                            </div>
                        </div>
