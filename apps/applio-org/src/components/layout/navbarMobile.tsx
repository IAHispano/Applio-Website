...
<header className="fixed w-full">
  ...
  >
    ...
    >
      {!isOpen ? (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color={"#ffffff"} fill={"none"} aria-hidden="true" className="w-[20px] h-[20px] mt-0.5">
  ...
  {isOpen && (
    <motion.div initial={{opacity: 0, filter: "blur(20px)"}} animate={{opacity: 1, filter: "blur(0px)"}} transition={{duration: 0.3}} className="w-screen h-screen bg-gradient-to-b from-transparent to-neutral-700/40 backdrop-filter backdrop-blur-lg overflow-y-auto p-8 pb-12"> 
    <Avatar />
    ...
    <a className="flex justify-between items-center gap-4 mt-4 mx-auto text-neutral-300 hover:text-white slow hover:bg-neutral-700/40 hover:px-4 rounded-xl p-1" href="/learn">
      <p>Learn</p>
