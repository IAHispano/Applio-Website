			...
			<div>
				<div className="flex xl:flex-cols-3 max-xl:flex-col w-full">
					<div className="flex justify-between p-4 h-fit bg-gradient-to-b from-[#110F0F] to-transparent backdrop-filter backdrop-blur-lg w-full">
						<a
							className="text-3xl font-semibold tracking-tight py-0.5"
							href="/"
						>
							Applio
						</a>
						...
						<div className="overflow-hidden fixed top-0 h-screen w-full mt-12 no-scroll">
							<section className="backdrop-filter backdrop-blur-xl mt-1 p-4 h-screen">
								<div className="flex max-xl:flex-col gap-4 w-full py-2 items-start justify-start xl:ml-12 mb-1 max-xl:mt-4 text-white/80">
									<a
										className="col-span-1 max-md:p-1 max-md:rounded-xl max-md:w-full"
										href="/models"
									>
										Explore
									</a>
									...
									<div className="col-span-1 max-md:px-1 max-md:rounded-xl max-md:w-full text-white/80 relative">
										...
										>
											...
											<h1
												className={`pt-2 ${dropdownOpen === 1 ? "font-bold pl-2" : ""}`}
											>
												Products
											</h1>
											{dropdownOpen === 1 && (
										...
										{dropdownOpen === 1 && (
											<div className="flex flex-col gap-4 mt-4 pb-6">
												<a className="rounded-xl p-2" href="/products/rvc">
													Applio
												</a>
												<a className="rounded-xl p-2" href="/products/app">
													Desktop App
												</a>
												<a
												...
												<a className="rounded-xl p-2" href="/products/bot">
													Discord Bot
												</a>
												<a
													className="rounded-xl p-2"
												...
												<a className="rounded-xl p-2" href="/products/api">
													Free API
												</a>
												<a
													className="rounded-xl p-2"
									...
									<div className="col-span-1 max-md:px-1 max-md:rounded-xl max-md:w-full text-white/80 relative">
										...
										>
											<h1
												className={`pt-2 ${dropdownOpen === 2 ? "font-bold pl-2" : ""}`}
											>
												About Us
											</h1>
											{dropdownOpen === 2 && (
										...
										{dropdownOpen === 2 && (
											<div className="flex flex-col gap-4 mt-4">
												<a className="rounded-xl p-2" href="/about/team">
													Team
												</a>
												<a className="rounded-xl p-2" href="/about/mission">
													Mission
												</a>
												<a
													className="rounded-xl p-2"
