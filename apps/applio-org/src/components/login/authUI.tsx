...
export default function AuthUI(){
    ...
    return (
      ...
      <div className="flex items-center justify-center p-6 md:h-[80svh] h-full">
        <div className="grid gap-4 max-md:rounded-t-xl mt-12 z-[2] absolute border border-white/10 top-[49%] left-[50%] max-h-full h-full md:h-full md:max-h-[70vh] w-full md:w-[90vw] md:max-w-[100vh] translate-x-[-50%] translate-y-[-50%] md:rounded-xl bg-white/10 backdrop-blur-3xl p-[25px] focus:outline-none ">
