		...
		<main>
			<div className="flex items-center justify-center p-6 h-[80svh]">
				<div className="max-w-2xl w-full md:h-fit h-full max-md:mt-44 md:m-44 bg-white/10 backdrop-blur-3xl md:p-12 max-md:p-4 rounded-lg">
					<h1 className="text-4xl font-medium tracking-lighter mt-0.5 mb-2">
						Fast link
					</h1>
					<input
						required
						...
						placeholder="Email"
						className="my-4 mt-6 w-full p-3 rounded-md bg-white/10 border border-white/10 text-white placeholder-white/80 focus:outline-none focus:border-white/40 focus:border-2"
					></input>
					...
					<button
						...
						className="w-full p-3 font-bold rounded-xl bg-white/10 text-white hover:bg-white/20  gtransition focus:outline-none"
						disabled={success}
					>
						Send Fast Link
					</button>
					{success && !error && (
						<div className="p-4 bg-white/10 h-44 w-full my-4 rounded-xl text-white text-center flex flex-col justify-center items-center">
							...
							>
								...
								<path color="rgb(34 197 94)" d="m16 19 2 2 4-4" />
							</svg>
							<p className="text-xs mt-2">
								Your fast link has been sent, check your email.
							</p>
						</div>
					)}
