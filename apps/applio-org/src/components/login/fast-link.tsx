    ...
    return (
      ...
      <div className="flex items-center justify-center p-6 h-[80svh]">
        ...
        <h1 className="text-4xl font-medium tracking-lighter mt-0.5 mb-2">Fast link</h1>
          ...
          <button onClick={handleFastLink} className="w-full p-3 font-bold rounded-xl bg-white/10 text-white hover:bg-white/20  gtransition focus:outline-none" disabled={success}>Send Fast Link</button>
          {success && !error && (
