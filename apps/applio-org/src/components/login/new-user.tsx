			...
			<div className="w-full h-full absolute top-0 bg-gradient-to-b from-[#333333] to-[#110f0f] z-50">
				<div className="flex justify-center items-center m-auto w-full h-full p-8">
					<div className="bg-[#4d4c4c] w-full h-full rounded-xl p-8 xl:max-w-[30%] md:max-w-[60%] md:max-h-[70%] flex flex-col gap-4">
						<h1 className="text-4xl font-medium tracking-lighter mt-0.5 mb-2 text-center">
							Welcome to Applio Community
						</h1>
						...
						{error && (
							<p className="bg-red-500/40 p-4 rounded-xl text-sm text-center">
								{error}
							</p>
						)}
						{success && (
						...
						<button
							...
							className="w-full bg-white text-black border border-white/20 hover:bg-opacity-80 hover:border-white/10 slow p-2 rounded-2xl font-semibold"
							disabled={success}
						>
							Join
						</button>
