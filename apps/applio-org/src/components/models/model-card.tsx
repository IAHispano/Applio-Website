    ...
    return (
      <a className="bg-white/10 border border-white/10 rounded-md w-full h-full p-4">
        ...
        <div className="max-md:mt-4 max-md:flex max-md:flex-col max-md:text-center">
            <button className="text-black bg-white hover:bg-white/80 slow px-6 py-2 w-fit h-fit rounded-full" onClick={handleDownload}>
        ...
        <div className="md:justify-between max-md:flex max-md:flex-col max-md:text-center flex mt-4">
