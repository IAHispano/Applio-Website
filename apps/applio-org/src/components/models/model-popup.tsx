...
const ModelPopup = ({
	...
	return (
		<div className="fixed inset-0 flex items-center justify-center bg-black/40 bg-opacity-50 z-50 max-lg:p-4 overflow-y-auto h-full max-md:pt-52 backdrop-filter backdrop-blur-xl">
