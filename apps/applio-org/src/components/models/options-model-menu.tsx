...
export default function OptionsModelMenu({ id }: { id: string }) {
	...
	return (
		<div className="flex gap-2 max-lg:mb-6 max-lg:w-full max-lg:mt-4">
			...
			<button
				className={`${liked ? "bg-white/30 hover:bg-white/40" : "bg-white/10 hover:bg-white/20"} max-md:border max-md:border-white/20 slow px-5 py-2 lg:w-fit w-full justify-center items-center mx-auto flex h-fit rounded-xl`}
				onClick={handleLike}
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
