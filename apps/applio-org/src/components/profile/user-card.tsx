...
export default function UserCard({ id }: { id: string }) {
	...
	const handleBadgeHover = (badgeType: string) => {
		setBadgeHovered(badgeType);
	};

	const handleBadgeLeave = () => {
		setBadgeHovered(null);
	};
				...
				<>
					<div className="md:w-[70svh] md:h-fit w-full h-fit p-4 rounded-xl border border-white/20 bg-white/10 backdrop-blur-3xl flex flex-col md:mt-24 z-20">
						{data.avatar_url && !error && (
							<div className="flex justify-start mt-6 max-md:md-auto md:ml-5 md:mr-auto z-50">
								<img
									src={data?.avatar_url}
									className="md:rounded-full rounded-xl max-md:w-full max-md:h-full h-[82px] w-[82px]"
						...
						<div className="md:justify-between w-full flex max-md:flex-col max-md:my-4 mt-4">
							<div
								className="flex justify-center items-center gap-2 my-auto max-md:mb-2 z-50 p-1 rounded-xl"
							...
							>
								{data?.premium === true && (
									<svg
										...
										onMouseEnter={() => handleBadgeHover("premium")}
								...
								{data?.developer === true && (
									<svg
										...
										fill="none"
										xmlns="http://www.w3.org/2000/svg"
										onMouseEnter={() => handleBadgeHover("developer")}
										onMouseLeave={handleBadgeLeave}
										className="cursor-pointer"
									>
										<path
								...
								{data?.writer === true && (
									<svg
										...
										fill="none"
										xmlns="http://www.w3.org/2000/svg"
										onMouseEnter={() => handleBadgeHover("writer")}
										onMouseLeave={handleBadgeLeave}
										className="cursor-pointer"
									>
										<path
								...
								{data?.admin === true && (
									<svg
										...
										fill="none"
										xmlns="http://www.w3.org/2000/svg"
										onMouseEnter={() => handleBadgeHover("admin")}
										onMouseLeave={handleBadgeLeave}
										className="cursor-pointer"
									>
										<path
							...
							<div className="p-1">
								{userData && userData.full_name !== id && (
									<button
										className={`${
											follow ? "bg-white/20" : ""
										} border border-white/10 py-1 text-sm hover:bg-white/10 slow px-6 rounded-xl max-md:w-full`}
