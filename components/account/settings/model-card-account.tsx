  ...
  return (
    <Card className="h-[200px] relative">
      <Dropdown backdrop="blur">
        <DropdownTrigger>
          <div className="absolute top-4 right-2 z-30" color="foreground">
            <MoreVertical />
          </div>
        </DropdownTrigger>
          ...
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">
                <span className="bg-gradient-radial-red text-transparent bg-clip-text text-2xl">
                  Warning
                </span>
                You are going to delete a model.
              </ModalHeader>
              <ModalBody>
                <p>
                  Please note that this action is irreversible, once you press
                  the delete button there is no way back, we will delete the
                  model data from our database for both the web and the bot.
                </p>
              </ModalBody>
              <ModalFooter>
