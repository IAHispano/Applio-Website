        ...
        {user && (
          <div className="md:py-2 mx-14">
            <h1 className="text-3xl md:text-5xl font-bold tracking-tight">
              Models created by{" "}
              <span
                className="underline decoration-[4px] italic underline-offset-4  select-all md:hover:tracking-wide gtransition-low
          decoration-green-500 "
            ...
            <p className="text-xs md:text-sm tracking-tight dark:text-neutral-300 text-left pt-1">
          ...
          >
            ...
            >
              ...
              >
                <div
                  role="button"
                  className="w-max rounded-lg p-1 text-red-500"
