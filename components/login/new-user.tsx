      ...
      <div className="flex items-center justify-center p-6 h-[80svh]">
        ...
        >
          ...
          <h1 className="text-xl ml-0.5 mt-2 ">
            Fill in your details and create an applio account.
          </h1>
          <form>
            <input
              required
            ...
            <input
              ...
              className="mb-8 w-full p-3 rounded-md bg-neutral-800 text-white placeholder-gray-500 focus:outline-none focus:border-white/40 focus:border-2"
              disabled={success}
            ></input>
          </form>
          ...
          <button
            ...
            className={`w-full p-3 font-bold rounded-md bg-neutral-800/80 text-white hover:bg-white/20 gtransition focus:outline-none border-2 border-white/20 ${success ? "cursor-not-allowed opacity-40 hover:none" : "cursor-pointer"}`}
            disabled={success}
          >
            Join the Applio family
          </button>
          {success && (
            <div className="p-4 bg-neutral-800 h-44 w-full my-4 rounded-xl text-white text-center flex flex-col justify-center items-center">
              ...
              >
                We have sent you an email, please check it to complete your
                registration.
              </motion.p>
            </div>
          )}
