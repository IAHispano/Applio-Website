...
export async function SiteHeader() {
  ...
  return (
    <section>
      ...
      <header className="w-full fixed top-0 left-0 h-16 bg-neutral-800/20 backdrop-blur-lg justify-center px-3 items-center border-b border-white/20 rounded-b-sm flex overflow-hidden">
