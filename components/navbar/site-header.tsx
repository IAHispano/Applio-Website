    ...
    <section>
      ...
      <div className=" hidden md:block">
        <header className="w-full fixed top-0 left-0 h-16 bg-neutral-800/20 backdrop-blur-lg justify-center px-3 z-50 items-center border-b border-white/20 rounded-b-sm flex overflow-hidden">
          <a
            href="/"
            className="mr-2 flex gap-2.5 items-center truncate hover:bg-white/10 active:bg-white/20 active:scale-90 p-2.5 rounded-xl false gtransition [&_img]:hover:ml-0 [&_img]:hover:scale-100 [&_img]:hover:blur-none [&_img]:hover:opacity-100"
          >
            <div className="w-8 h-8 aspect-square">
              <img
                id="a"
                src="/no_bg_applio_logo.png"
                className="md:-ml-10 md:scale-75 md:blur md:opacity-0 gtransition"
                alt="logo"
              />
            </div>
